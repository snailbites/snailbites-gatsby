...
![Seamless Homepage Post-Facelift](./SL_homepage.png){:class="img-responsive useBorder"}
...
![GrubHub Homepage Post-Facelift](./GH_homepage.png){:class="img-responsive useBorder"}
